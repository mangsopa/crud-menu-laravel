            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLanding" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-rocket-line"></i> <span data-key="t-landing">Konfigurasi</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                {{-- <a href="{{ route('Menu') }}" class="nav-link" data-key="t-one-page"> Menu </a> --}}

                                <a href="{{ route('konfigurasi.menu.index') }}" class="nav-link"
                                    data-key="t-one-page">
                                    Menu </a>
                            </li>
                        </ul>
